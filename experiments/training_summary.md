...
| DDQN evaluation return | -76.608 | -14.769 | Rolling evaluation improves by 61.032; inspect the rolling trend rather than one episode. |
| MADRL joint loss | 1.380 | -0.242 | Compact CTDE runs are stability diagnostics, not equilibrium proofs. |
