...
\begin{document}
\tutorialtitle{Code Running Guide}{How to Run and Extend the Note 1 Python Examples}{Installation, smoke tests, training diagnostics, outputs, and troubleshooting}{Companion to the cyber control and game-learning tutorial note}
\tableofcontents
\newpage
...
\end{lstlisting}
Expected output: refreshed PNG figures under \texttt{docs/assets/}, including neural architecture, timing-semantics, FBSM, hybrid rollout, and policy-comparison plots.
