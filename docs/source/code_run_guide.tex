...
\end{lstlisting}
Expected output: refreshed PNG figures under \texttt{docs/assets/}, including neural architecture, action timing, FBSM, hybrid rollout, and policy-comparison plots.
