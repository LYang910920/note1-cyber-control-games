...
\begin{document}
\tutorialtitle{Note 1 Code Running Guide}{Cyber Control and Game-Learning Examples}{Installation, smoke tests, training diagnostics, outputs, and troubleshooting}{Companion to Note 1: Cyber Control and Game Learning}
\tableofcontents
\newpage
\lhead{\small\sffamily Note 1 Code Running Guide}
