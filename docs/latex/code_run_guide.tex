...
\end{lstlisting}
Expected output: refreshed PNG figures under \texttt{figures/}, including neural architecture, timing-semantics, FBSM, hybrid rollout, and policy-comparison plots.
...
\item the training-diagnostics, game-response, and node-level robustness PNG figures.
\end{itemize}
...
Node-level robustness plot & Parameter-mismatch stress test: nominal FBSM open-loop schedule versus DDQN aggregate feedback on a stochastic graph. \\
\bottomrule
\end{longtable}
