...
\begin{document}
\tutorialtitle{Implementation Companion}{Python Examples for Cyber Control, Differential Games, RL/MADRL, PINN, and PIDL}{From mathematical formulation to reproducible experiments}{Companion to Tutorial Notes 1 and 2}
\tableofcontents
\newpage
