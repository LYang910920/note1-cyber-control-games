...
from cybercontrol.models import SampledSIRParams
...
SCENARIOS: dict[str, CyberScenarioProfile] = {
    "tutorial-sampled-impulse-small": CyberScenarioProfile(
        ...
        first_files_to_edit=("src/cybergames/envs.py", "src/cybergames/actions.py"),
    ...
    "impulse-visible-defense": CyberScenarioProfile(
        ...
        first_files_to_edit=("src/cybergames/envs.py", "src/cybergames/evaluation.py"),
    ...
    "paper-network-bridge": CyberScenarioProfile(
        ...
        first_files_to_edit=(
            "src/cybergames/robustness.py",
            "src/cybergames/adversarial_env.py",
            "src/cybergames/ctde.py",
        ),
...
TRAINING_HYPERPARAMETERS: tuple[TrainingHyperparameterProfile, ...] = (
    TrainingHyperparameterProfile(
        ...
        source="cybergames.fbsm.solve_fbsm",
    ),
    TrainingHyperparameterProfile(
        name="ddqn-defender",
        method="DDQN neural defender",
        hyperparameters=(
            ("command", "python -m cybergames medium --device auto"),
            ("episodes", "30 per seed in the bounded medium profile"),
            ("horizon/eval_horizon", "20 / 20"),
            ("eval_episodes", "3"),
            ("hidden width", "64"),
            ("batch_size", "32"),
            ("learning rate", "1e-3"),
        ...
        source="cybergames.cli._medium and cybergames.ddqn",
    ),
    TrainingHyperparameterProfile(
        ...
        hyperparameters=(
            ("command", "python -m cybergames medium --device auto"),
            ("episodes", "4 per seed for the bounded response study"),
            ("horizon", "6"),
            ("hidden width", "32"),
            ("learning rate", "5e-4"),
            ("gamma", "0.97"),
        ...
        source="cybergames.self_play and cybergames.cli._medium",
    ),
    TrainingHyperparameterProfile(
    ...
    TrainingHyperparameterProfile(
        ...
        source="src/cybergames/mappo.py",
    ),
    TrainingHyperparameterProfile(
        ...
        hyperparameters=(
            ("command", "python -m cybergames medium --device auto"),
            ("nodes", "64 in training; held-out evaluations use independent seeds"),
            ("communities", "4"),
            ("graph", "sparse Barabasi-Albert, row-normalized"),
            ("defender/attacker budgets", "1 / 1 communities per decision epoch"),
            ("learner", "state-conditioned actor-critic; static logits are a labelled baseline"),
            ("cross-play opponents", "uniform, degree, risk, oracle, budget-random, learned"),
            ("held-out evaluation", "fixed-policy cross-play uses independent seeds"),
            ("summary output", "artifacts/medium/medium_metrics.csv"),
        ),
        source="src/cybergames/adversarial_env.py; src/cybergames/self_play.py",
    ),
)
